...
function JobOpening() {
  return (
    <>
      <main className="bg-[rgba(0,0,0,0.6)] backdrop-blur-[20px] rounded-lg md:grid grid-cols-2 justify-center md:mx-[3.4rem] p-3 md:m-auto m-3  border-[#2D2646]  border-[1px] ">
        <form action="#">
        ...
        <section className="pl-8 text-white">
          ...
          <h1 className="text-[20px] mb-4">Discover Job Openings</h1>
