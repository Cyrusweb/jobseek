  ...
  return (
    <>
      <main className="mt-[20px] px-4">
        <article className=" md:flex justify-around flex-row-reverse">
          <img
            src={banner}
            alt="banner"
            className="w-[330px] mt-[14px] lg:w-[549.89px] px-[30px] pt-[-6px]"
          />
          <section className="">
            ...
            <div>
              <p className="  md:w-[491.39px] lg:text-[52px] lg:font-medium lg:leading-[62.4px] md:text-left mt-[30px]  text-[#FFFFFF] text-[35px] font-medium leading-[49.2px] text-center">
                Find your{" "}
                <span className="text-[#848484]">dream job with jobBoard</span>
              </p>

              <p className="text-[18px]  md:w-[366.72px] md:text-left font-normal leading-[27px] text-center mt-[27px] text-white">
