  ...
  return (
    <>
      <main className="md:text-left text-center lg:w-[80%] md:mx-12 p-3 m-auto ">
        ...
        <p className=" md:mx-0     lg:font-medium lg:leading-[62.4px] md:text-left mt-[30px] md:mt-[2px]  text-[#FFFFFF] text-[29px] font-medium leading-[39.2px] md:text-[36px] text-center">
          One step to your{" "}
